...
const reviewedExperienceSchema = new mongoose.Schema({
  name: {
    type: String,
  ...
  timestamps: true,
  collection: 'ReviewedExperience'
});

module.exports = mongoose.model('ReviewedExperience', reviewedExperienceSchema);